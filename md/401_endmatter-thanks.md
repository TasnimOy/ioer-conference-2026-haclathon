...
We explicitly thank the colleagues at the [IOER Monitor of Settlement and Open Space Development](https://www.ioer-monitor.de/) for providing the comprehensive data basis and the API that powers some of the workflows in this book. Their work enables us to analyze spatial trends in Germany with high precision.
...
Please [let us know](mailto:fdz@ioer.de) what you think of this initiative. If you are inspired to contribute further, please check the [Contributing section](../CONTRIBUTING).
