...
*   **[Topic: Digital Landscape Traces](201_digital_landscape_traces.ipynb)** ![Interactive](https://img.shields.io/badge/Interactive-Python-blue?style=flat-square) ![Colab](https://img.shields.io/badge/Colab-Tested-yellow?style=flat-square) - *Alexander Dunkel (IOER) & Dominik Weckmüller (TU Dresden)*
...
*   **[Topic: Story Map Hidden Herons in Urban Spaces](202_settlement_delineation_ibtool.ipynb)** ![Story](https://img.shields.io/badge/Data_Story-StoryMap-orange?style=flat-square) - *Gongmingyue Tang (IOER)*
...
*   **[Topic: Automatic delineation of inner zone (§ 34 BauGB)]** ![Tutorial](https://img.shields.io/badge/Tutorial-QGIS-green?style=flat-square) - *Oliver Harig*\
