...
:::{grid-item-card} Path A: The Writer (Domain Experts)
...
Start here: **[Read the Guide for Writers](01_guide_writers.md)**
:::

:::{grid-item-card} Path B: The Developer (Coders)
...
Start here: **[Read the Guide for Developers](02_guide_developers.md)**
:::
